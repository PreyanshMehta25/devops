...
const Navbar: React.FC = () => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      const res = await fetch(
        `https://stackit-mgsi.onrender.com/api/notifications?clerkUserId=${user.id}`,
      );
  ...
  const handleMarkAllRead = async () => {
    ...
    try {
      await fetch(
        "https://stackit-mgsi.onrender.com/api/notifications/mark-read",
        {
          method: "PATCH",
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-2xl font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 text-white hover:shadow-lg hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <div className="flex flex-col gap-3">
              ...
              <button
                ...
                className="flex items-center gap-3 px-4 py-3 rounded-2xl font-semibold bg-gradient-to-r from-emerald-500 to-teal-500 text-white transition-all duration-300"
              >
